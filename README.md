...
The owner/admin dashboard, Firebase Authentication login, Firestore quote dashboard, editable content dashboard, and dashboard photo-upload tools have been removed.
